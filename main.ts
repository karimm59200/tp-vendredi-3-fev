...
let btnC = document.querySelector("#btnC") as HTMLButtonElement;
...
let imgDog = document.querySelector("imgDog") as HTMLDivElement;

// let img = document.createElement("img") as HTMLImageElement;
let img = document.querySelector("#monImage") as HTMLImageElement;
let divs= document.querySelector("div") as HTMLDivElement;
